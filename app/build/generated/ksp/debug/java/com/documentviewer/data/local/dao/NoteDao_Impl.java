...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNoteEntity = new EntityInsertionAdapter<NoteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`content`,`createdAt`,`modifiedAt`,`filePath`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfNoteEntity = new EntityDeletionOrUpdateAdapter<NoteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes` SET `id` = ?,`title` = ?,`content` = ?,`createdAt` = ?,`modifiedAt` = ?,`filePath` = ? WHERE `id` = ?";
      }
  ...
  public Flow<List<NoteEntity>> getAllNotes() {
    final String _sql = "SELECT * FROM notes ORDER BY modifiedAt DESC";
      ...
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpModifiedAt,_tmpFilePath);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public NoteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpModifiedAt,_tmpFilePath);
          } else {
            _result = null;
          }
          return _result;
